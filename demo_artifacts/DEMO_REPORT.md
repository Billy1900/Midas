...
- Online feature used: `atr-normalised-vwap-deviation-needs-sign`
- Online alerts: `7`
- Kill signals: `0`
- Mock/API call count: `13`
...
- Pattern identified: `ATR-normalised VWAP deviation needs sign validation before promotion`
- Expression:
...
[
  {
    "feature_name": "atr-normalised-vwap-deviation-needs-sign",
    "alert_type": "ic_decay",
    "severity": "critical",
